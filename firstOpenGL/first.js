...
function startGL() 
{
  ...
  let vertexPosition = [
    ...
    //First
    -3.0, -2.0, +1.0,  -3.0, +2.0, +1.0,  -2.0, -2.0, +1.0,

    //Second
    -2.0, -2.0, +1.0,  -2.0, +2.0, +1.0,  -3.0, +2.0, +1.0,

    //Third
    -0.5, -2.0, +1.0,  -2.0, -0.0, +1.0,  -2.0, +0.5, +1.0,

    //Forth
    -0.5, -2.0, +1.0,  +0.5, -2.0, +1.0,  -2.0, +0.5, +1.0,

    //Fifth
    -0.5, +1.0, +1.0,  -1.0, +2.0, +1.0,  -3.0, +2.0, +1.0,
